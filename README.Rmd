...
`tools4watlas` is documented in detail on the [**package website**](https://allertbijleveld.github.io/tools4watlas/). The package vignettes describe the basic workflow when working with WATLAS data and follow a logic order of steps. Further articles give additional tutorials and insights into the package development (read if you want to contribute to `tools4watlas`), some (indicated by an asterisk) require access to the local NIOZ file server.
...
**Package development**:
  ...
  - [**tools4watlas logo**](https://allertbijleveld.github.io/tools4watlas/articles/package_development/package_logo.html)
...
- check: exported tag metadata has timezone UTC for the release time, which is different from our metadata (CEST)?
