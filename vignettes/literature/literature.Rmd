...
A pipeline with coding examples for cleaning, for instance by Filter-Smoothing, high-throughput tracking data with `atlastools` (`tools4watlas` builds on `atlastools`) is presented in **@gupte2022**. 
