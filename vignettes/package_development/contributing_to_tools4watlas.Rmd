---
title: "Contributing to tools4watlas"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Contributing to tools4watlas}
...
For more details see the book [R Packages](https://r-pkgs.org/) by Hadley Wickham and Jennifer Bryan, and read the documentation of the packages we use (see section [Required packages]( https://allertbijleveld.github.io/tools4watlas/articles/package_development/package_maintenance.html#required-packages) below). 
