...
Work in progress! Add function to plot data with tag ID and date range as title,
by number of base stations, var, and time, plus last N locations.
...
bm +
  geom_path(
    data = data_subset, aes(x, y, colour = datetime),
    alpha = 0.1, show.legend = FALSE
  ) +
  geom_point(
    data = data_subset, aes(x, y, colour = datetime),
