...
Simply colour points and the path with tag ID. The When one needs individual consistent colours between plots, one can use `atl_tag_cols(data$tag)` to assign them (see second example). 
