...
setnames(dr, tolower(names(dr)))
dr <- dr[, .(
  bs = kast_nr, location = locatie, year = jaar, x, y,
  date_placed = datum_plaatsen, date_removed = datum_afbreken,
  permanent = vast, active = actief, mudflats, height_bs = hoogte
)]
