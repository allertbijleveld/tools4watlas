...
Returns the average of all columns for each time step. The additional column `n_aggregated` shows how many locations were aggregated for this location.
...
```{r, eval = FALSE}
# Save data
fwrite(thinned_aggregated, file = "../inst/extdata/watlas_data_aggregated.csv",
       yaml = TRUE)
```
