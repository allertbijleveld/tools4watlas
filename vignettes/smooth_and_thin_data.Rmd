...
Returns the mean of all columns for each time step. The additional column `n_aggregated` shows how many positions were aggregated for this position. Time and datetime are returned rounded down to the desired interval (in seconds).
