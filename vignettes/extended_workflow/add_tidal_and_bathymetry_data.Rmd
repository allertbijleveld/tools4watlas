...
This article shows how to add tidal and bathymetry data to WATLAS data, subset data within tidal cycle, and visualise the tracking data on the bathymetry.
...
Bathymetry data can be downloaded from [Rijkswaterstaat](https://waterinfo.rws.nl/) but can also be found in the "Birds, fish 'n chips" SharePoint folder: `Documents/data/GIS/rasters/`. To run the below script, set the file path (`fp`) to the local copy of the folder on your computer. 

Here, we show how to extract bathymetry data (cm NAP) for each WATLAS position and calculate tidal time (time relative to the tidal cycle). 
