...
Ignores different sampling intervals and species specific residency patch parameters at the moment.
...
data <- data[, .(tag, posID, time, datetime, x, y, speed_in, tideID)]
...
atl_check_res_patch(
  tag = "3038", tide = "2023513", buffer_res_patches = 50, offset = 30,
  data, tide_data
)
```
