...
Most `tools4watlas` function run on collections of lists `split()` by individual (tag) to keep the data separated and allow for easy parallel computing (if necessary). 
