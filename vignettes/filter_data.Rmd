...
```{r, fig.cap = "Heatmap of all positions", message = FALSE}
...
```{r, fig.cap = "Histogram of speed"}

# split in list as get_speed() does not work by tag
...
# split in list to recalculate speed
data_list <- split(data, by = "tag")
