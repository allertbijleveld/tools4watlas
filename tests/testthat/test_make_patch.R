...
#   test_output <- tools4watlas::atl_res_patch(
#     data = test_data,
#     buffer_radius = 10,
#     lim_spat_indep = 100,
#     lim_time_indep = 30,
...
#   )
#   tools4watlas:::atl_check_data(test_output, names_expected = expected_names)
# 
...
#   data_access_smry <- tools4watlas::atl_patch_summary(
#     patch_data = test_output,
#     which_data = "summary"
#   )
# 
#   # access test_output spatial
#   data_access_sf <- tools4watlas::atl_patch_summary(
#     patch_data = test_output,
#     which_data = "spatial"
#   )
# 
#   # access test_output spatial
#   data_access_pt <- tools4watlas::atl_patch_summary(
#     patch_data = test_output,
#     which_data = "points"
#   )
# 
